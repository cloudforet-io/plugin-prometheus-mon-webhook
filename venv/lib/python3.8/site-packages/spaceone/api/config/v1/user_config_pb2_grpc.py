...
class UserConfigStub(object):
    ...
    def __init__(self, channel):
        ...
        self.create = channel.unary_unary(
                ...
                request_serializer=spaceone_dot_api_dot_config_dot_v1_dot_user__config__pb2.CreateUserConfigRequest.SerializeToString,
...
def add_UserConfigServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'create': grpc.unary_unary_rpc_method_handler(
                    servicer.create,
                    request_deserializer=spaceone_dot_api_dot_config_dot_v1_dot_user__config__pb2.CreateUserConfigRequest.FromString,
...
class UserConfig(object):
    ...
    def create(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.config.v1.UserConfig/create',
            spaceone_dot_api_dot_config_dot_v1_dot_user__config__pb2.CreateUserConfigRequest.SerializeToString,
